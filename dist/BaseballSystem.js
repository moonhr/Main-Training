...
class BaseballSystem {
    ...
    createTeam(teamData) {
        ...
        const team = Object.assign(Object.assign({}, teamData), { uuid });
    ...
    createPlayer(playerData) {
        const uuid = this.generateUUID();
        const player = Object.assign(Object.assign({}, playerData), { uuid });
    ...
    createGame(gameData) {
        const uuid = this.generateUUID();
        const game = Object.assign(Object.assign({}, gameData), { uuid });
     ...
     */
    createGameRecord(recordData) {
        const uuid = this.generateUUID();
        const record = Object.assign(Object.assign({}, recordData), { uuid });
     ...
     */
    getPlayerGameRecords(playerId) {
        // gameRecords Map의 모든 값을 배열로 변환하고 playerId가 일치하는 기록만 필터링
        return Array.from(this.gameRecords.values()).filter((record) => record.playerId === playerId);
    }
    /**
     * 팀 경기 조회 메서드
     ...
     */
    getTeamGames(teamId) {
        return Array.from(this.games.values()).filter((game) => game.homeTeamId === teamId || game.awayTeamId === teamId);
    }
    /**
     * 선수 통계 계산 메서드
